...
public struct ScienceYearReviewEvent : GenericUpcomingEvent {
    public typealias ValueKeys = ScienceYearReviewEventValueKeys
    ...
    public init(event_date: EventDate!, title: String, description: String?, location: String?, image_url: String?, years: [Int:[ClientWikipediaEvent]]) {
        ...
        if let imageURL:String = image_url, let prefix:String = UpcomingEventType.science_year_review.image_url_prefix, imageURL.starts(with: prefix) {
