...
public struct ClientHoliday : Jsonable {
    ...
    public func getTranslationKeyValue(key: ClientHolidayTranslationKeys) -> Any? {
        switch key {
    ...
    public mutating func setTranslationKeyValue<T>(key: ClientHolidayTranslationKeys, value: T) {
        switch key {
        case .name:
