...
public struct HomeResponseGovernment : HomeResponseProtocol {
    ...
    public var recent_activity:Set<CountryGovernmentRecentActivity>
    
    public init(recent_activity: Set<CountryGovernmentRecentActivity>) {
    ...
    public mutating func setKeyValue<T>(key: HomeResponseGovernmentValueKeys, value: T) {
        ...
        case .recent_activity:
            recent_activity = value as! Set<CountryGovernmentRecentActivity>
            break
        }
    }
}
